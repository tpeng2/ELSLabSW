    ...
    string13 = 'specdata/eta_agfft_p_r'  // '_' // trim(which3)
    string13i = 'specdata/eta_agfft_p_i'  // '_' // trim(which3)
    ! open(unit=9979,file=string11,access='DIRECT',&
    ! & form='BINARY',status='UNKNOWN',RECL=4*szftrdrow*szftrdcol*nz)
    ...
    string14 = 'specdata/eta_gfft_r'  // '_' // trim(which3)
    string14i = 'specdata/eta_gfft_i'  // '_' // trim(which3)
