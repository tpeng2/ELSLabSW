       ...
       WRITE(which,'(I3)') 100 + icount2
       string1 = 'data/w_avg1'  // '_' // which(1:3)
       string2 = 'data/eta_avg1'  // '_' // which(1:3)
       string3 = 'data/weta_avg1'  // '_' // which(1:3)
...
!      tmp_out(1) = Psurf(i,j)/9.8/2/dt
       tmp_out(1) = w_avg1(i,j)/icount_wp1
       tmp_out(2) = eta_avg1(i,j)/icount_wp1
       tmp_out(3) = weta_avg1(i,j)/icount_wp1 - &
           &        tmp_out(1)*tmp_out(2)
